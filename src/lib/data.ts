...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 3, 8, 7, 0),
    end: new Date(2025, 3, 8, 7, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2025, 3, 9, 11, 55),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 3, 4, 13, 0),
    end: new Date(2025, 3, 10, 13, 55),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 3, 9, 9, 0),
    end: new Date(2025, 3, 11, 10, 55),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 7, 13, 9, 0),
    end: new Date(2025, 7, 13, 9, 55),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 7, 13, 10, 0),
    end: new Date(2025, 7, 13, 10, 55),
  },
  
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 3, 10, 2, 20),
    end: new Date(2025, 3, 10, 2, 53),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 3, 7, 5, 7),
    end: new Date(2025, 3, 7, 5, 24),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 3, 10, 3, 39),
    end: new Date(2025, 3, 10, 4, 13),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 3, 9, 4, 34),
    end: new Date(2025, 3, 9, 5, 25),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 3, 11, 7, 12),
    end: new Date(2025, 3, 11, 7, 55),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 3, 11, 12, 40),
    end: new Date(2025, 3, 11, 1, 4),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 3, 8, 3, 59),
    end: new Date(2025, 3, 8, 4, 50),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 3, 10, 6, 43),
    end: new Date(2025, 3, 10, 7, 25),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 3, 11, 10, 0),
    end: new Date(2025, 3, 11, 10, 14),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 3, 11, 3, 46),
    end: new Date(2025, 3, 11, 4, 6),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 3, 10, 10, 26),
    end: new Date(2025, 3, 10, 11, 22),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 3, 8, 7, 53),
    end: new Date(2025, 3, 8, 8, 47),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 3, 7, 2, 37),
    end: new Date(2025, 3, 7, 3, 5),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 3, 7, 6, 37),
    end: new Date(2025, 3, 7, 6, 58),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 3, 7, 10, 42),
    end: new Date(2025, 3, 7, 11, 32),
  },
